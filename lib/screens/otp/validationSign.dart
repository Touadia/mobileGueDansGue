...
import 'package:gue_dans_gue_mobile/screens/inscription/signOK.dart';
import 'package:gue_dans_gue_mobile/screens/inscription/sign_up_form.dart';

import '../../widget/constants.dart';

class ValidationSign extends StatefulWidget {
  const ValidationSign({Key? key}) : super(key: key);

  @override
  _ValidationSignState createState() => _ValidationSignState();
}

class _ValidationSignState extends State<ValidationSign> {
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => SignOK()),
              );
            },
            child: Text(
              "Valider",
